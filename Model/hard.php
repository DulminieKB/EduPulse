<?php
  ...
  if ($input != $solution) {
      $score -= 100; //reduce by 300 if the answer is incorrect
  }
...
<body>
  ...
  <h3>HARD</h3>
    ...
    <div class="lowBox" style="display: flex; justify-content: end;">
      <h2 id="time-left-title" style="color: white;">Time remaining:  <span id="timer">20 seconds</span></h2>
    </div>
  ...
  <script>
    ...
    function handleInput() {
      ...
      if (input.value == solution) {
        ...
        //if 3 incorrect answers are given, start from begining
        if (ansIncorrect >= 3) { 
          clearInterval(timer);
