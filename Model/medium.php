<?php
  ...
  if ($input != $solution) {
      $score -= 200; //reduce by 200 if the answer is incorrect
  }
...
<body>
  ...
  <h1 id="title">EDU PULSE <span id="title"></h1>
    ...
    <div class="lowBox" style="display: flex; justify-content: end;">
      <h2 id="time-left-title" style="color: white;">Time remaining:  <span id="timer">30 seconds</span></h2>
    </div>
    </div>
  ...
  <script>
    ...
    function handleInput() {
      ...
      if (input.value == solution) {
        ...
        //if 4 incorrect answers are given, start from begining
        if (ansIncorrect >= 4) { 
          clearInterval(timer);
